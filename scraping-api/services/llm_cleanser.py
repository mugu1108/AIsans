...
### 1. 企業名の正規化（最重要）
**出力する企業名は「株式会社〇〇」「〇〇株式会社」「合同会社〇〇」「有限会社〇〇」の形式のみにする**

titleから正しい企業名を抽出する例：
- 「株式会社〇〇｜公式サイト」→「株式会社〇〇」
- 「〇〇 | 会社案内」→「株式会社〇〇」（URLドメインから法人格を推測）
- 「idealogical Japan合同会社 | IT コンサルティン」→「idealogical Japan合同会社」
- 「経営をITと財務の面から支援する合同会社」→ 除外（企業名が不明）
- 「発注先・相談先をお探しなら【システム開発」→ 除外（キャッチコピー）
- 「WebマーケティングコンサルティングならWE」→ 除外（途中で切れている）
- 「沿革：〇〇株式会社」→「〇〇株式会社」（接頭辞を削除）

**除外すべき企業名パターン：**
- 「〇〇なら」「〇〇をお探しなら」で始まるキャッチコピー
- 法人格（株式会社/有限会社/合同会社）を含まず、企業名が特定できないもの
- 途中で切れている不完全な名前（「...」「～」で終わるなど）
- 「継手 バルブ 製造・販売」などの製品説明のみ
